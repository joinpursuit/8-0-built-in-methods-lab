...
function getHighestOfTwoScores(score1, score2) {
  const score1Percent = Math.round (score1.received * 100 / score1.max);
  const score2Percent = Math.round (score2.received * 100 / score2.max);
  return score1Percent > score2Percent ? score1Percent : score2Percent;
}
