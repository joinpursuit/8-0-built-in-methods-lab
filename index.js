...
let result = {}
result = Math.round((score.received / score.max)  * 100)
return result;
}
...
let newObj = {}
newObj = Math.round((score1.received / score1.max)  * 100)

let newObj2 = {}
newObj2 = Math.round((score2.received / score2.max)  * 100)

return Math.max(newObj, newObj2)
}

// this is a different solution calling getPercentageScore function!! both solutions worked!
