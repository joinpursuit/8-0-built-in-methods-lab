...
function getPercentageScore(score) {
  let percentResult = Math.round((score.received / score.max) * 100)
...
let score1Highest = Math.round((score1.received / score1.max) * 100)
let score2Highest = Math.round((score2.received / score2.max) * 100)

return Math.max(score1Highest, score2Highest)
}
