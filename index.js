...
function getPercentageScore(score) {
  const percentageOfScore = (score.received / score.max * 100);
  console.log(percentageOfScore)
  
  return Math.round(percentageOfScore);
}
...
function getHighestOfTwoScores(score1, score2) {
  const firstScore = (score1.received / score1.max * 100);
  const secondScore = (score2.received / score2.max * 100);

  theHighestScore = (firstScore, secondScore)
  console.log(theHighestScore);
  
  return Math.max(Math.round(theHighestScore));
}
