...
function getPercentageScore(score) {
  let percentageScore = Math.round((score.received / score.max) * 100);
...
function getHighestOfTwoScores(score1, score2) {
  // use helper function getPercentageScore to get the percentage score for parameter score1
  // use helper function getPercentageScore to get the percentage score for parameter score2
  // compare score1 and score2 by using method, Math.max(), store this in a variable
  // return the variable, representing the max score
  const highestScore = Math.max(getPercentageScore(score1), getPercentageScore(score2));
  return highestScore;
}
