...
function getPercentageScore(score) {
  return num = Math.round(score.received / score.max * 100)
}
...
function getHighestOfTwoScores(score1, score2) {
  return highest = Math.max (
    num1 = Math.round(score1.received / score1.max * 100),
    num2 = Math.round(score2.received / score2.max * 100)
  )
}
