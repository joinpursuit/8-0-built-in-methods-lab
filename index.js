...
function getHighestOfTwoScores(score1, score2) {
  const highestPercentageScored1 = getPercentageScore(score1)
  const highestPercentageScored2 = getPercentageScore(score2)

  return Math.max(highestPercentageScored1, highestPercentageScored2)
}
