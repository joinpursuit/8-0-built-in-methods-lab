...
function getHighestOfTwoScores(score1, score2) {
  let highestScore = Math.round ((score1.received / score1.max) * 100)

  if (Math.round ((score2.received / score2.max) * 100) > highestScore){
    highestScore = Math.round ((score2.received / score2.max) * 100)
  }
