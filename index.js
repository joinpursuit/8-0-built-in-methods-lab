...
function getPercentageScore(score) {
  let scorePercentage = Math.round((score.received / score.max) * 100);
...
function getHighestOfTwoScores(score1, score2) {
  let scorePercentage1 = Math.round((score1.received / score1.max) * 100);
  let scorePercentage2 = Math.round((score2.received / score2.max) * 100);

  if (scorePercentage1 > scorePercentage2) {
