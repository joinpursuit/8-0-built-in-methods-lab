...
function getAssignmentTypes(assignments) {
  return Object.keys(assignments);  //Courtesy of a find by David
}
...
function getPercentageScore(score) {
  ...
  // console.log(score.received / score.max * 100);
...
function getHighestOfTwoScores(score1, score2) {
  if ((Math.round(score1.received / score1.max * 100) > (Math.round(score2.received / score2.max * 100)))){
