...
function getHighestOfTwoScores(score1, score2) {
  let roundScore1 = Math.round(score1.received / score1.max * 100);
  let roundScore2 = Math.round(score2.received / score2.max * 100);
  if(roundScore1 > roundScore2){
    roundedHi = roundScore1;
  }else{
    roundedHi = roundScore2;
  }
  return roundedHi;
}
