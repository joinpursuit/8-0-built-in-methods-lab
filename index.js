...
function getHighestOfTwoScores(score1, score2) {
  // Declare a variable for score1
  // Math.round method rounds the entire percentage operation
  let first =  Math.round(score1.received / score1.max * 100)
  // Declare a variable for score2: 
  let second = Math.round(score2.received / score2.max * 100)
  // highest percentage value from two scores
