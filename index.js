...
let stringCreated = [Object.keys(assignments)]
return stringCreated.join(",")
}
...
function getHighestOfTwoScores(score1, score2) {
  let theFirstScore =  (Math.round((score1.received/score1.max)*100))

  let theSecondScore = (Math.round((score2.received/score2.max)*100))
  
  return theFirstScore>theSecondScore?theFirstScore:theSecondScore
