...
function getAssignmentTypes(assignments) {
  keysList =  Object.keys(assignments)
  return keysList
}
...
function getPercentageScore(score) {
  scorePercent = (score.received/score.max)*100
...
function getHighestOfTwoScores(score1, score2) {
  scorePercent1 = (score1.received/score1.max)*100
  scorePercent2 = (score2.received/score2.max)*100
 percent1 = Math.round(scorePercent1)
 percent2 =  Math.round(scorePercent2)
