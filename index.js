...
function getAssignmentTypes(assignments) {
  ...
  // Alternative way to obtain all the keys utilizing a for-in loop
  // keys = []
...
function getHighestOfTwoScores(score1, score2) {
  let perc1 = Math.round((score1.received / score1.max) * 100)
  let perc2 = Math.round((score2.received / score2.max) * 100)
