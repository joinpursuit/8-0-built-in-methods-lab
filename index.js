...
/*
 let answer = "";
  answer = Object.keys(assignments);
  return answer;
  */
}
...
function getPercentageScore(score) {
  let answer = score.received / score.max;
...
function getHighestOfTwoScores(score1, score2) {
  let score_1 = score1.received / score1.max;
  score_1 = Math.round(score_1 * 100)
  let score_2 = score2.received / score2.max;
  score_2 = Math.round(score_2 * 100)
