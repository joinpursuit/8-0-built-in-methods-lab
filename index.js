...
//ASSIGNMENTS IS THE OBJECT. WE WANT ONLY THE KEYS FROM THE PROPERTIES
...
function getPercentageScore(score) {
  //CREATE A VARIABLE TO STORE MATH OPERATION TO GET PERCENT
...
function getHighestOfTwoScores(score1, score2) {
  let highScore = (score1.received / score1.max) * 100
  let anotherScore = (score2.received / score2.max) * 100

  return Math.round(Math.max(highScore, anotherScore))
  //THE CODE ON LINE 47 USES CODE FROM PREVIOUS FUNCTION AS A HELPER FUNCTION TO SOLVE THIS PROBLEM
