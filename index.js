...
function getHighestOfTwoScores(score1, score2) {
  ...
  let firstPercentage = Math.round(firstScore);
  let secondScore = (score2.received / score2.max) * 100;
  let secondPercentage = Math.round(secondScore);

  let highestScore = firstPercentage;

  if (secondPercentage > highestScore) {
    highestScore = secondPercentage;
  }
