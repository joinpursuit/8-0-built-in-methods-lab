...
function getPercentageScore(score) {
  let percentageScore;
  percentageScore = ( score.received / score.max ) * 100;
  roundedPercentageScore = Math.round( percentageScore )
...
percentages1 = ( score1.received / score1.max ) * 100 ;
percentages2 = ( score2.received / score2.max ) * 100 ;

return Math.max ( Math.round ( percentages1 ) , Math.round ( percentages2 ));
