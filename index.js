...
function getHighestOfTwoScores(score1, score2) {
  let percentageScore1 = Math.round((score1.received/ score1.max)*100);
  let percentageScore2 = Math.round((score2.received/ score2.max)*100);
  return Math.max(percentageScore1, percentageScore2);
}
