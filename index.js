...
function getPercentageScore(score) {
  let percent = score.received/score.max * 100
...
function getHighestOfTwoScores(score1, score2) {
  let thisScore = Math.round(score1.received/score1.max * 100)
  let thatScore = Math.round(score2.received/score2.max * 100)
  return Math.max(thisScore, thatScore);
}
