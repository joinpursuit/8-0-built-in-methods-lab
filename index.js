...
function getHighestOfTwoScores(score1, score2) {
 let mathOneScore = Math.round((score1.received/score1.max) * 100)
 let mathTwoScore = Math.round((score2.received/score2.max) * 100)
 return (Math.max(mathOneScore,mathTwoScore))
