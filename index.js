...
function getHighestOfTwoScores(score1, score2) {
  let result = Math.round((score1.received / score1.max) * 100);
  let results = Math.round((score2.received / score2.max ) * 100);
  let highestOfTwo;

  result > results ? highestOfTwo = result : highestOfTwo = results;
