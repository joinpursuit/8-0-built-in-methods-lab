...
function getAssignmentTypes(assignments) {
  //return category name as an array string
...
function getPercentageScore(score) {
  //return a number with a ROUNDED integer...
  let percentage = score.received / score.max * 100; //basic percentage formula
...
function getHighestOfTwoScores(score1, score2) {
  //returning highest num = Math.max?

  return Math.max(score1)
}
