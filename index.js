...
function getHighestOfTwoScores(score1, score2) {
  let firstPercentageScore = getPercentageScore(score1)
  let secondPercentageScore = getPercentageScore(score2)


  return Math.max(firstPercentageScore, secondPercentageScore)
}
