...
function getPercentageScore(score) {
  let receivedAndMax = Object.values(score);
  let percentageDecimal = receivedAndMax[0] / receivedAndMax[1];

  return Math.round(percentageDecimal * 100);

  // let percentageDecimal = score.received / score.max;

  // return Math.round(percentageDecimal * 100);

  //score received, divided by 100
  //separate line multiplying that result by 100 to turn it into an integer.

  //open question: I'm wondering if the JS Doc actually meant that it wants us to have three parameters. I ended up only using one parameter for the function.
}
