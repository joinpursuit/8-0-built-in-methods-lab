...
function getPercentageScore(score) {
  let percent = Math.round((score.received / score.max) *+ 100);
  return percent;
}
...
function getHighestOfTwoScores(score1, score2) {
  let percenta = Math.round((score1.received / score1.max) * 100);
  let percentb = Math.round((score2.received / score2.max) * 100)
