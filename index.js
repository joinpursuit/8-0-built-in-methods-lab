...
function getPercentageScore(score) {
   ...
   let finP = values[0] / values[1] * 100;
   return Math.round(finP)
}
...
function getHighestOfTwoScores(score1, score2) {
  let values1 = Object.values(score1);
  let values2 = Object.values(score2);
   let finP1 = Math.round(values1[0] / values1[1] * 100);
   let finP2 = Math.round(values2[0] / values2[1] * 100);
   return Math.max(finP1,finP2);
}
