...
let number = score.received / score.max
...
let highPercent1 = Math.round((score1.received/ score1.max)*100)
let highPercent2 = Math.round((score2.received/ score2.max)*100)
return Math.max(highPercent1, highPercent2)
}
