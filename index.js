...
function getHighestOfTwoScores(score1, score2) {
  let myScore1 = Math.round((score1.received / score1.max) * 100);
  let theirScore2 = Math.round((score2.received / score2.max) * 100);

  return myScore1 > theirScore2 ? myScore1:theirScore2;
}
