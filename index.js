...
function getHighestOfTwoScores(score1, score2) {
  ...
  let scoreOne = Math.round(score1.received * 100/score1.max)
  let scoreTwo = Math.round(score2.received * 100/score2.max)


  return Math.max(scoreOne, scoreTwo)
}
//NOTE TO SELF - BE MINDFUL OF SPELLING! One 'received' was spelled wrong! Making all the tests fail!
