...
function getHighestOfTwoScores(score1, score2) {
  let percentageOne = Math.round((score1.received / score1.max) * 100);
  let percentageTwo = Math.round((score2.received / score2.max) * 100);
  return Math.max(percentageOne, percentageTwo);
}
